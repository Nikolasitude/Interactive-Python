...
class InteractiveInterpreter:
    ...
    def runcode(self, code, source):
        ...
        If there is a self.path, the input will be stored in the file of the path
        There is a difference between a statement (which evaluates a value)
        And an expression (which actually do something)

        The statements are mundain and don't need to be stored
        However, expressions are stored 
        ...
        Please note that a function without syntax error will be stored in the file
        This also happen 
...
def interact(saving_path=None, banner=None, readfunc=None, local=None, exitmsg=None):
    ...
    saving_path -- if not None, inputs will be stored in the file path
